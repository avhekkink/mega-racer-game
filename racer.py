...
class Racer:
    ...
    def render(self, view, renderingSystem):
        ...
        # I'm choosing the z-axis as the model-space forward direction so that I can utilise the function mat4_from_zAxis
        # Using the make_mat4_from_zAxis function in lab_utils, I set the translation to the position of the racer,
        # I set the the 'z-axis' to the forwards direction of the racer, i.e. its heading
        # And I set the 'y-axis' to the up direction in our world space, i.e. [0,0,1]
        # This function scales, centres and rotates our model to position it in our world space
    ...
    def load(self, objModelName, terrain, renderingSystem):
        ...
        # I'm choosing to use the low-poly model provided in the skeleton of this project, in order to speed up loading time
        self.model = ObjModel("data/racer_02.obj")
